...
public class WeatherForecastRepository(IRedisConnectionProvider redisConnectionProvider) : IWeatherForecastRepository
{
    private readonly IRedisCollection<WeatherForecast> redisCollection = redisConnectionProvider.RedisCollection<WeatherForecast>();
